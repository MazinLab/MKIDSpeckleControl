...
#ifndef SPECKLEKALMANPOISSON_H
#define SPECKLEKALMANPOISSON_H
class SpeckleKalmanPoisson : public SpeckleController
{
    private:
        ...
        cv::Mat mPi; // initial process noise
        ...
        std::vector<cv::Mat> mzList; // Measurement vector (2D; real/imag phase intensities)
        std::vector<cv::Mat> mHList; // Observation matrix
    ...
    public:
        SpeckleKalmanPoisson(cv::Point2d pt, boost::property_tree::ptree &ptree, cv::Mat apertureMask);
